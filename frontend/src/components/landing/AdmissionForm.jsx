...
export default function AdmissionForm() {
  ...
  return (
    <section id="apply" data-testid="admission-form-section" aria-label="Apply for admission" className="py-16 sm:py-24 lg:py-28 bg-slate-950 text-white relative overflow-hidden">
